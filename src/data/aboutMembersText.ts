...
> = {
  ...
  fr: {
    edgar: {
      ...
      descriptionLead:
        'Manie la guitare et, à l’occasion, amuse la galerie. Adepte des métriques sinueuses, sa note de prédilection nous tire toujours au détour du prochain virage. Il injecte sa passion du rock classique dans chaque riff et chaque solo de Frisches. Entre intros à rallonge et jeux de mots douteux, conte préféré finit toujours par mener à ',
    },
    cami: {
      name: 'Cami',
    ...
    steff: {
      ...
      descriptionLead:
        'Véritable métronome de Frisches, Steff tient le tempo d’une main de maître: ici, comme le dit Ringo, le f*ing clic, c’est elle. Qu’il neige ou qu’il vente, rien ne l’arrete. Le rituel du mardi est sacré : Pizza Funghi, sans pesto.Prochain rajout à ses atouts ? La double pédale, pour rajouter encore un peu plus de coffre à sa grosse caisse et à l’âme de nos morceaux. Pour elle, rien ne groove plus qu’',
      descriptionTail: ' !',
    },
    tobi: {
      name: 'Tobi',
